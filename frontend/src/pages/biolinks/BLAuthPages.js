...
// BLAuthPages - integrated into MarkPro BioLinks section
export default function BLAuthPages() {
  return (
    <div>
      <div className="page-header-row">
        <div><div className="page-title">Auths</div></div>
      </div>
      <div className="card"><div className="card-body">
        <div className="empty-state">
          <div className="empty-title">BioLinks - BLAuthPages</div>
